...
You can launch a quick question on the [#antwerp-ui slack channel](https://dgpls.slack.com/messages/C4M60PQJF).
...
- Start the demo app
  ...
  To use the remote page you also need to start the [backing service](https://github.com/digipolisantwerp/chatbot_service_nodejs).
